...
public class 캐릭터 { //구조체
    ...
    int 경험치 = 0;
    int 레벨업경험치; // 레벨 *5로 설정?
    아이템 낡은검 = new 아이템("낡은검", 1, 0, 1, "다 낡아빠진 검이다"); // 아이템호출
    아이템 철검 = new 아이템("철검", 1, 1, 3, "단단한 철로 만들어진 날카로운 검이다");
    아이템 고블린왕의_몽둥이 = new 아이템("고블린왕의_몽둥이", 1, 2, 5, "조악해 보이지만 한 종족의 왕이 썻던 무기인만큼 튼튼하다");
    아이템 가죽갑옷 = new 아이템("가죽갑옷", 2, 100, 2, "초급 모험가들이 즐겨입는 가죽갑옷이다");
    아이템 철갑옷 = new 아이템("철갑옷", 2, 101, 5, "철로 만들어져 꽤 강력한 공격까지 막아낼수 있을듯하다");
    아이템 체력포션 = new 아이템("체력포션",3,900,5, "단순히 체력이 조금 회복될뿐인 싸구려 포션이다");
    아이템 마나포션 = new 아이템("마나포션",4,901,5, "단순히 마나가 조금 회복될뿐인 싸구려 포션이다"); //나중에 지우자
