...
public class 전사 extends 인간 {
    ...
    public 전사(String _이름, int _레벨, int _공격력, int _방어력, int _회피율, int _체력, int _최대체력, int _마나, int _최대마나, int _돈, int _경험치, int _레벨업경험치,int _마법력,int _종족구분,int _종족,String _종족이름,boolean _종족스킬제한, int _직업번호) {
        super.이름 = _이름;
        super.레벨 = _레벨;
        super.공격력 = _공격력;
        super.방어력 = _방어력;
