...
public class 스켈레톤_메이지 extends 스켈레톤 {
    public int 직업번호 = 2;
    스켈레톤_메이지(){};
    public 스켈레톤_메이지(String _이름, int _레벨, int _공격력, int _방어력, int _회피율, int _체력, int _최대체력, int _마나, int _최대마나, int _돈, int _경험치, int _레벨업경험치,int _마법력,int _종족구분,int _종족,String _종족이름,boolean _종족스킬제한, int _직업번호) {
        super.이름 = _이름;
        super.레벨 = _레벨;
        super.공격력 = _공격력;
        super.방어력 = _방어력;
    ...
    public void 스켈레톤_메이지(스켈레톤 _스켈레톤){
        this.이름 = super.이름;
        this.레벨 = super.레벨;
        this.공격력 = super.공격력 ;
        this.방어력 = super.방어력 ;
