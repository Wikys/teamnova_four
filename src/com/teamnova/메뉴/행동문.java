...
//        _판매스킬목록.add(헬파이어);
        ...
        while (true) {
            ...
            전직.전직여부(_캐릭터);
            메뉴.유저상태_초기화(_캐릭터, 스킬샵); //버프나 기타등등으로 올라간 능력치 초기화,제한스킬 초기화
            ...
            if (선택 == 1) {
                ...
                while (true) {
                    _전투메뉴.캐릭터_전투_스테이터스(_캐릭터, 몬스터); // 유저 상태창
                    _전투메뉴.몬스터_전투_스테이터스(몬스터, _캐릭터); // 몬스터 상태창
...
//                        }
                ...
                //스킬샵
                스킬샵.스킬구매목록(_캐릭터, _캐릭터._버프스킬목록,_캐릭터._회복스킬목록,_캐릭터._공격스킬목록);
