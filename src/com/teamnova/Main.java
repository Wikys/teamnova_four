...
//                    System.out.println(소지품.인벤토리);
                        ...
                        if (사용.contains("낡은검") && 인벤토리.contains(낡은검)) { //계속 장착되는거 막아야함
                            ...
                            선택 = in.nextInt();
                            continue 행동문;
                        } else if (사용.contains("철검") && 인벤토리.contains(철검)) { //계속 장착되는거 막아야함
                            ...
                            선택 = in.nextInt();
                            continue 행동문;
                        }else if (사용.contains("가죽갑옷") && 인벤토리.contains(가죽갑옷)) { //계속 장착되는거 막아야함
                            ...
                            선택 = in.nextInt();
                            continue 행동문;
                        }else if (사용.contains("철갑옷") && 인벤토리.contains(철갑옷)) { //계속 장착되는거 막아야함
...
//                        else if (사용.contains("체력포션") && 인벤토리.contains(체력포션)) { //계속 장착되는거 막아야함
//                            System.out.println("체력이 " + 체력포션.체력회복 + " 회복 되었습니다");
//
//                            유저명.전투중체력 = 유저명.전투중체력 + 체력포션.체력회복;
//                            인벤토리.remove(체력포션);
//                            System.out.println("돌아가시려면 아무숫자나 입력하세요");
//                            선택 = in.nextInt();
//                            continue 행동문;
//                        }
                ...
                for(int i=0; i<장비창.size(); i++){
                    System.out.println("아이템 이름: " + i + ". " + 장비창.get(i).이름);
