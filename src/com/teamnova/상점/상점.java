...
import com.teamnova.아이템.분류.조악한_완드;
...
//  public   com.teamnova.아이템.아이템 낡은검가격 = new 아이템(0); // 아이템호출
    ...
    public 조악한_완드 조악한완드 = new 조악한_완드(); //고치기
    //아이템 추상화하고 싹다고치기
    ...
    public void 판매목록(캐릭터 _캐릭터){
        ...
        System.out.println("6.조악한 완드 "+조악한완드.가격+" Gold");
        System.out.println();
        ...
        if (입력 == 1){ //구매선택하면 아이템정보 출력
            ...
            System.out.println("====================");
            System.out.println("아이템명: " + this.조악한완드.이름);
            this.조악한완드.설명();
            System.out.println("====================");
